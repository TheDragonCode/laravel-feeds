...
Follow the [multiple targeted feed files recipe](./receipt-target-feeds.mdx) for a complete feed class, generation commands, and expected output paths.

## See Also

- [Multiple targeted feed files recipe](./receipt-target-feeds.mdx)
