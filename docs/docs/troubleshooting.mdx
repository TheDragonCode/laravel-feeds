...
The disk must resolve to `Illuminate\Filesystem\FilesystemAdapter` and support writable streams, moves, directory management, listings, and deletion. Read-only disks and contract-only custom implementations fail before the database query begins.
