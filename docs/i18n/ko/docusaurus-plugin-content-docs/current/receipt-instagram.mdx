---
title: "Instagram"
description: "Instagram용 피드 생성 레시피"
type: recipe
status: stable
since: "1.0"
...
[← 이전](./receipt-sitemap.mdx) · [README로 돌아가기](https://github.com/TheDragonCode/laravel-feeds#readme) · [다음 →](./receipt-yandex.mdx)
...
생성된 클래스에서 `extends Feed`를 `extends InstagramFeedPreset`으로 바꾸십시오.
