---
title: "Instagram"
description: "Рецепт генерации фида для Instagram"
type: recipe
status: stable
since: "1.0"
...
[← Предыдущая](./receipt-sitemap.mdx) · [Назад к README](https://github.com/TheDragonCode/laravel-feeds#readme) · [Следующая →](./receipt-yandex.mdx)
...
В сгенерированном классе замените `extends Feed` на `extends InstagramFeedPreset`:
