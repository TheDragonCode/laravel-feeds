---
title: "Instagram"
description: "Recette de génération d’un flux pour Instagram"
type: recipe
status: stable
since: "1.0"
...
[← Précédent](./receipt-sitemap.mdx) · [Retour au README](https://github.com/TheDragonCode/laravel-feeds#readme) · [Suivant →](./receipt-yandex.mdx)
