---
title: "Шаблони"
description: "Швидке генерування фідів за допомогою вбудованих шаблонів Instagram, Yandex, Sitemap і RSS"
type: reference
status: stable
since: "1.0"
...
[← Попередня](./location.mdx) · [Назад до README](https://github.com/TheDragonCode/laravel-feeds#readme) · [Наступна →](./events.mdx)

# Шаблони

Фіди можна швидко створювати за допомогою готових шаблонів:
...
Створіть клас фіду вручну або за допомогою консольної команди `php artisan make:feed <name>` та успадкуйте потрібний шаблон. Наприклад:
...
Потім реалізуйте два обов’язкові методи: `builder` і `item`. Наприклад:
...
Технічно класи шаблонів такі самі, як базовий клас `Feed`, але містять логіку цільового сервісу, зокрема правила побудови інформаційних блоків та елементів.

## Типові реалізації {/* #defaults */}
