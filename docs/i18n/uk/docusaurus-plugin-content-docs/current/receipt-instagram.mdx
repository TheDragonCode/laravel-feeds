---
title: "Instagram"
description: "Приклад генерування фіду для Instagram"
type: recipe
status: stable
since: "1.0"
...
[← Попередня](./receipt-sitemap.mdx) · [Назад до README](https://github.com/TheDragonCode/laravel-feeds#readme) · [Наступна →](./receipt-yandex.mdx)
...
У згенерованому класі замініть `extends Feed` на `extends InstagramFeedPreset`:
