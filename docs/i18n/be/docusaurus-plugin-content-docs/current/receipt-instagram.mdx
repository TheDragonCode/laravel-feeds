---
title: "Instagram"
description: "Рэцэпт генерацыі стужкі для Instagram"
type: recipe
status: stable
since: "1.0"
...
[← Папярэдняя](./receipt-sitemap.mdx) · [Назад да README](https://github.com/TheDragonCode/laravel-feeds#readme) · [Наступная →](./receipt-yandex.mdx)
...
У згенераваным класе замяніце `extends Feed` на `extends InstagramFeedPreset`:
